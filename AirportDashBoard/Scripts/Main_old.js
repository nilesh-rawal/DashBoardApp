...
function GetLoliPopSeriesData(obj, columnKey, labelKey) {
...
function GetLoliPopSeriesDataConstant(obj, columnKey, labelKey) {
    ...
    for (var i in obj) {
        ...
        else if (time == MaxValue[0] || time == MaxValue[2]) {
            var obj1 = {
                "value": value,
                "label": obj[i][labelKey],
                "anchorRadius": "17"
...
function GetMaximumValue(obj, key) {
    ...
    for (var i in obj) {
        ...
        if (maxValue < obj[i][key])
            maxValue = obj[i][key];
    }
    if (key == 'MOVEMENTS') alert(maxValue);
    return maxValue;
}
...
function GetLolipopChartL2(jsonObject, img) {
    FusionCharts.ready(function () {
        //alert(Math.round((1.25 * GetMaximumValue(jsonObject, 'DELAY_MINS')) / 1000) * 1000)
        var salesAnlysisChart = new FusionCharts({
            type: 'mscombidy2d',
            ...
            dataSource: {
                ...
                "dataset": [
                       ...
                       },
                       {
                           ...
                           "color": "none",
                           "anchorBgColor": "000000",
                           "data": GetLoliPopSeriesData(jsonObject, 'DELAY_MINS', 'TIMEPERIOD')
                       },
                       {
...
function CreateKPI1L2ArrivalDepartureChart(arrivaljsonObject, departurejsonObject) {
    debugger;
    //alert(Math.round((1.25 * GetMaximumValue(arrivaljsonObject, 'DELAY_MINS')) / 1000) * 1000)
    FusionCharts.ready(function () {
        var salesAnlysisChart = new FusionCharts({
            type: 'mscombidy2d',
            renderAt: 'chartContainer',
        ...
        var salesAnlysisChart = new FusionCharts({
            ...
            dataSource: {
                "chart": {
                    ...
                    "showLegend": "0",
                    //"numVDivlines": "2",
                    //"adjustVDiv": "1",//slot adherence  front chart
                    "numDivLines": "3",
                    "adjustDiv": "1",//rounds decimal value
                   // "pYAxisvaluesstep": "1",
                   // "sYAxisvaluesstep": "1",
